...
## Workflow
1. Before answering, ground yourself in the injected profile, memories, learned
   knowledge, and prior decisions. Tailor depth and tone to what you know.
...
maintains a user profile, user memories, learned knowledge (reusable playbooks),
and a decision log across sessions.
